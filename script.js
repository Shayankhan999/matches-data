function MatchesData(teamOneName, teamTwoName, winner, teamScore1, teamScore2, matchstatuss, team1Flag, team2Flag) {
  ...
  let match24 = new MatchesData("Namibia", "Australia", "Aus won by 9 wickets (89 balls left)", "72 (17)", "74/1 (5.4)", "today", "img/download (9).png", "img/download (3).png");
  let match25 = new MatchesData("United states", "India", "IND won by 7 wickets (12 balls left)", "110/8 (20)", "122/3 (18.2)", "yesterday", "img/download (7).png", "img/download (8).png");
